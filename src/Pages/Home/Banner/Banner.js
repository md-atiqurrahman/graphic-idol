...
const Banner = () => {
    return (
            <div className="min-h-screen bg-[url('/src/assets/images/cup-coffee-table.jpg')] bg-fixed bg-center bg-no-repeat bg-cover 
             -mt-[74px] text-center">
            <div className='bg-primary absolute top-[73px] opacity-90 pt-[115px] px-[244px] pb-[32px]'>
